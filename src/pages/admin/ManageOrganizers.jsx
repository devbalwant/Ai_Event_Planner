          ...
          {loading ? (
            ...
            <div className="space-y-3 max-w-2xl">
              {displayed.map((org) => (
                <div
                  key={org._id}
                  className="bg-white dark:bg-[#1f3329] border border-gray-200 dark:border-gray-700 rounded-xl p-5 flex items-center justify-between gap-4"
                >
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-[#437057] text-white rounded-full flex items-center justify-center text-sm font-bold shrink-0">
