        ...
        <div className="flex-1 p-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-1">
              <div className="bg-white dark:bg-[#242424] border border-gray-200 dark:border-gray-700 rounded-2xl p-6 shadow-sm">
                ...
                <div className="space-y-3">
                  ...
                  <button
                    onClick={addGuest}
                    className="w-full bg-[#C4A574] hover:bg-[#B09560] text-[#0f0f0f] py-2.5 rounded-lg text-sm font-semibold transition-colors"
                  >
                    Add Guest
                  </button>
                </div>
              ...
              {filtered.length === 0 ? (
                ...
                <div className="space-y-3">
                  {filtered.map((guest) => (
                    <div
                      key={guest.id}
                      className="bg-white dark:bg-[#242424] border border-gray-200 dark:border-gray-700 rounded-xl p-4 flex items-center justify-between gap-4"
                    >
                      <div className="flex items-center gap-3">
                        <div className="w-9 h-9 bg-[#8B1538] text-white rounded-full flex items-center justify-center text-sm font-semibold shrink-0">
                      ...
                      <div className="flex items-center gap-2 shrink-0">
                        ...
                        {guest.status === "Invited" && (
                          <button
                            ...
                            className="text-xs text-[#8B1538] dark:text-white hover:underline font-medium"
                          >
                            Confirm
                          </button>
                        )}
